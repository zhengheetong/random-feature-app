...
export default function GachaTracker() {
  ...
  const currentRate =
    totalPulls > 0 ? ((ssrCount / totalPulls) * 100).toFixed(2) : 0.0;
    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            style={{ color: "#f39c12", fontSize: "3rem", fontWeight: "bold" }}
          >
            {ssrCount}
          </div>
        </div>
        ...
        <div
          style={{
            ...
            boxShadow:
              totalPulls > 0
                ? `0 0 15px ${isLucky ? "rgba(46, 204, 113, 0.2)" : "rgba(231, 76, 60, 0.2)"}`
                : "none",
          }}
        >
          <div
          ...
          <div
            style={{
              color:
                totalPulls === 0 ? "#ffffff" : isLucky ? "#2ecc71" : "#e74c3c",
              fontSize: "3rem",
              fontWeight: "bold",
            }}
          >
